        ...
        <div className="bg-indigo-600 p-8 md:w-1/4 flex flex-col justify-between text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 mb-8">
              Upgrade to access advanced AI tools, unlimited scheduling, and
              agency features.
            </p>
        ...
        <div className="flex-1 p-6 md:p-8 bg-slate-50 dark:bg-slate-950 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-8 flex-1">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> 3
                  Social Accounts
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> 10 AI
                  Credits/mo
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> Basic
                  Scheduling
                </li>
              </ul>
              <button
            ...
            >
              ...
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-8 flex-1">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> 10
                  Social Accounts
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> 100 AI
                  Credits/mo
                </li>
                <li className="flex gap-2">
                ...
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> Link in
                  Bio Pro
                </li>
              </ul>
              <button
            ...
            >
              ...
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-8 flex-1">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> 25
                  Social Accounts
                </li>
                <li className="flex gap-2">
                ...
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> Team
                  Collaboration
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> API
                  Access
                </li>
              </ul>
              <button
