      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden border border-slate-200 dark:border-slate-800 flex flex-col md:flex-row max-h-[90vh] md:max-h-none overflow-y-auto md:overflow-visible">
        ...
        <div className="bg-indigo-600 p-8 md:w-1/4 flex flex-col justify-between text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 mb-8">
              Upgrade to access advanced AI tools, unlimited scheduling, and agency features.
            </p>
        ...
        <div className="flex-1 p-6 md:p-8 bg-slate-50 dark:bg-slate-950 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Free Plan */}
            <div
              className={`p-6 rounded-2xl border ${currentPlan === 'free' ? 'border-indigo-500 ring-1 ring-indigo-500 bg-white dark:bg-slate-900' : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900'} flex flex-col`}
            >
              <div className="mb-4">
              ...
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-8 flex-1">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> 3 Social Accounts
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> 10 AI Credits/mo
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> Basic Scheduling
                </li>
              </ul>
              <button
            ...
            {/* Pro Plan */}
            <div
              className={`p-6 rounded-2xl border relative ${currentPlan === 'pro' ? 'border-indigo-500 ring-1 ring-indigo-500 bg-white dark:bg-slate-900' : 'border-indigo-200 dark:border-indigo-900 bg-indigo-50/30 dark:bg-indigo-900/10'} flex flex-col`}
            >
              {currentPlan !== 'pro' && (
              ...
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-8 flex-1">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> 10 Social Accounts
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> 100 AI Credits/mo
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> Advanced Analytics
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-indigo-500 shrink-0" /> Link in Bio Pro
                </li>
              </ul>
              <button
            ...
            {/* Agency Plan */}
            <div
              className={`p-6 rounded-2xl border ${currentPlan === 'agency' ? 'border-indigo-500 ring-1 ring-indigo-500 bg-white dark:bg-slate-900' : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900'} flex flex-col`}
            >
              <div className="mb-4">
                <h4 className="text-lg font-bold text-slate-900 dark:text-white">Agency</h4>
                <p className="text-2xl font-bold mt-2">
                  $45 <span className="text-sm font-normal text-slate-500">/mo</span>
                </p>
                <p className="text-xs text-slate-500 mt-1">For teams & businesses</p>
              </div>
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-8 flex-1">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> 25 Social Accounts
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> Unlimited AI
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> White-Label Reports
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> Team Collaboration
                </li>
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" /> API Access
                </li>
              </ul>
              <button
