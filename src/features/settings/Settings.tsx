...
import { MOCK_TEAM, MOCK_AUDIT_LOG } from '@/utils/constants';
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                    Manage your social media connections. Pro plan allows up to 10 accounts.
                  </p>
                </div>
      ...
      case 'team':
        return (
          <div className="space-y-6 animate-in fade-in duration-300 relative">
            {userPlan !== 'agency' && (
              <div className="absolute inset-0 z-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8 rounded-2xl">
                ...
                <p className="text-slate-600 dark:text-slate-400 max-w-md mb-6">
                  Collaborate with your team, assign roles, and manage approval workflows with the
                  Agency plan.
                </p>
                <button
            ...
            <div
              className={`bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 ${userPlan !== 'agency' ? 'opacity-50 pointer-events-none select-none' : ''}`}
            >
              <div className="flex justify-between items-start mb-6">
                <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
                      Receive a weekly summary of your performance and upcoming posts.
                    </p>
                  </div>
                  <button
                    onClick={() =>
                      setNotifications((prev) => ({ ...prev, emailDigest: !prev.emailDigest }))
                    }
                  ...
                  >
                    <span
                      className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform ${notifications.emailDigest ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-start justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
                      Get notified when a scheduled post goes live or fails.
                    </p>
                  </div>
                  <button
                    onClick={() =>
                      setNotifications((prev) => ({ ...prev, postSuccess: !prev.postSuccess }))
                    }
                  ...
                  >
                    <span
                      className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform ${notifications.postSuccess ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-start justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
                      Alert me when someone mentions my brand or comments on a post.
                    </p>
                  </div>
                  <button
                    onClick={() =>
                  ...
                  >
                    <span
                      className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform ${notifications.mentions ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-start justify-between">
                  ...
                  >
                    <span
                      className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform ${notifications.marketing ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </button>
                </div>
              </div>
          ...
          <div className="space-y-6 animate-in fade-in duration-300 relative">
            {userPlan !== 'agency' && (
              <div className="absolute inset-0 z-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8 rounded-2xl">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">
                  Agency Feature Locked
                </h3>
                <p className="text-slate-600 dark:text-slate-400 max-w-md mb-6">
                  Upgrade to the Agency plan to remove SocialFlow branding and customize the
                  platform with your own logo and colors.
                </p>
                <button
                  onClick={onOpenUpgrade}
                  className="px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/30"
          ...
          <div className="space-y-6 animate-in fade-in duration-300 relative">
            {userPlan !== 'agency' && (
              <div className="absolute inset-0 z-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8 rounded-2xl">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">
                  Developer API Locked
                </h3>
                <p className="text-slate-600 dark:text-slate-400 max-w-md mb-6">
                  Access our REST API and Webhooks to build custom integrations and workflows with
                  the Agency plan.
                </p>
                <button
                  onClick={onOpenUpgrade}
  ...
  return (
    <div className="p-6 md:p-8 h-full flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors duration-200">
      ...
      <div className="flex flex-col md:flex-row gap-8 h-full">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <nav className="space-y-1">
            {[
              ...
              const isLocked =
                ((item.id === 'branding' || item.id === 'developer') && userPlan !== 'agency') ||
                (item.id === 'team' && userPlan !== 'agency');
        ...
        {/* Content Area */}
        <div className="flex-1 min-w-0 overflow-y-auto pb-20">{renderContent()}</div>
      </div>
    </div>
  );
};
