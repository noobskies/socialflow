...
import { ShortLink, BioPageConfig, ToastType } from '@/types';
import { generateBio } from '@/services/geminiService';
import { MOCK_LINKS, MOCK_LEADS } from '@/utils/constants';
...
const LinkManager: React.FC<LinkManagerProps> = ({ showToast }) => {
  ...
  const [links] = useState<ShortLink[]>(MOCK_LINKS);
                ...
                {bioConfig.enableLeadCapture && (
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setBioConfig((prev) => ({ ...prev, leadCaptureText: e.target.value }))
                      }
