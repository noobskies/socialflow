...
export const MOCK_INTEGRATIONS = [
  {
    id: "1",
    name: "Shopify",
    description: "Sync products and create posts automatically",
    category: "ecommerce",
    icon: "shopping-bag",
    connected: true,
    features: ["Product sync", "Order notifications", "Inventory tracking"],
  },
  {
    id: "2",
    name: "Slack",
    ...
    icon: "slack",
    connected: false,
    features: ["Post notifications", "Crisis alerts", "Team mentions"],
  },
  {
    id: "3",
    name: "WordPress",
    description: "Auto-publish blog posts to social media",
    category: "content",
    icon: "globe",
    connected: true,
    features: ["Auto-posting", "Content sync", "SEO integration"],
  },
  {
    id: "4",
    name: "Mailchimp",
    description: "Sync email campaigns with social posts",
    category: "communication",
    icon: "mail",
    connected: false,
    features: ["Campaign sync", "Subscriber growth", "Email analytics"],
  },
];
