                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      <div
                        className={`p-1 rounded-full ${getPlatformColor(item.platform)}`}
                      >
        ...
        {activeTab === "messages" && selectedMessage ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-slate-400 dark:text-slate-600 p-8 text-center">
            ...
            <p className="max-w-md text-sm">
              Select a mention on the left to view details, analyze sentiment,
              and engage directly from here. Tracking 3 keywords.
            </p>
          </div>
        ) : (
