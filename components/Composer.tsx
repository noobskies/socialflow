...
const Composer: React.FC<ComposerProps> = ({
  ...
  const handleScheduleSubmit = () => {
    ...
    const recurringMsg =
      repeatInterval !== "never" ? ` (Repeats ${repeatInterval})` : "";
                ...
                {selectedPlatforms.includes("instagram") && (
                  <div className="space-y-2">
                    <label className="flex items-center text-sm font-medium text-pink-600 dark:text-pink-400">
                      <Instagram className="w-3 h-3 mr-1.5" /> Instagram First
                      Comment
                    </label>
                    <textarea
                    ...
                    <>
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2 flex items-center">
                          <LayoutTemplate className="w-3 h-3 mr-1" /> Quick
                          Templates
                        </label>
          ...
          <div className="sticky top-0">
            ...
            <div className="space-y-6">
              {selectedPlatforms.map((platform) => {
                ...
                const tweetParts = isTwitter
                  ? getTweetParts(content)
                  : [content];
