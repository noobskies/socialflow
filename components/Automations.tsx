              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="New Shopify Product">
                      New Shopify Product
                    </option>
                    <option value="New WordPress Post">
                      New WordPress Post
                    </option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewWorkflow({ ...newWorkflow, action: e.target.value })
                    }
                    className="w-full border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-indigo-500"
                  >
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-start space-x-4">
                    ...
                    >
                      {workflow.icon === "shopping-bag" && (
                        <ShoppingBag className="w-6 h-6" />
                      )}
                      {workflow.icon === "globe" && (
                        <Globe className="w-6 h-6" />
                      )}
                      {workflow.icon === "alert-triangle" && (
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-6 text-white shadow-lg">
              ...
              <p className="text-indigo-100 text-sm mb-4">
                Tell me about your business, and I'll design the perfect
                automation strategy.
              </p>
