...
const MOCK_LEADS: Lead[] = [
  ...
  {
    id: "2",
    email: "mike.dev@tech.co",
    source: "Bio Link",
    capturedAt: "5 hours ago",
  },
  {
    id: "3",
    email: "designer@creative.studio",
    source: "Bio Link",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="mt-2 text-xs text-emerald-600 dark:text-emerald-400 flex items-center font-medium">
                <ArrowRight className="w-3 h-3 mr-1 rotate-[-45deg]" /> +12%
                this week
              </div>
            </div>
            <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                    ...
                    >
                      ...
                      <td className="py-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            onClick={() =>
                              copyToClipboard(`sfl.ai/${link.shortCode}`)
                            }
        ...
        <div className="flex flex-col lg:flex-row gap-8 h-[calc(100vh-200px)] animate-in fade-in duration-300">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span
                      className="text-xs text-indigo-600 dark:text-indigo-400 cursor-pointer flex items-center"
                  ...
                  <textarea
                    value={bioConfig.bio}
                    onChange={(e) =>
                      setBioConfig({ ...bioConfig, bio: e.target.value })
                    }
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    onClick={() =>
                      setBioConfig((prev) => ({
                        ...prev,
                        enableLeadCapture: !prev.enableLeadCapture,
                      }))
                    }
                  ...
                  >
                    <span
                      className={`inline-block h-3 w-3 transform rounded-full bg-white transition-transform ${bioConfig.enableLeadCapture ? "translate-x-5" : "translate-x-1"}`}
                    />
                  </button>
                </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setBioConfig((prev) => ({
                          ...prev,
                          leadCaptureText: e.target.value,
                        }))
                      }
              ...
              <div className="space-y-3">
                ...
                {bioConfig.links.map((link, index) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => {
                        const newLinks = bioConfig.links.filter(
                          (_, i) => i !== index
                        );
                        setBioConfig({ ...bioConfig, links: newLinks });
                      }}
          ...
          <div className="w-full lg:w-[380px] shrink-0 flex justify-center items-start pt-8">
            <div className="w-[320px] h-[650px] bg-slate-900 rounded-[40px] border-8 border-slate-800 shadow-2xl overflow-hidden relative">
              ...
              {/* Bio Page Content */}
              <div
                className={`w-full h-full overflow-y-auto bg-white pt-12 pb-8 px-6 ${bioConfig.theme === "dark" ? "bg-slate-900 text-white" : bioConfig.theme === "colorful" ? "bg-gradient-to-br from-indigo-500 to-purple-600 text-white" : "bg-slate-50 text-slate-900"}`}
              >
