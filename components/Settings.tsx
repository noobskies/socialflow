              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                    Manage your social media connections. Pro plan allows up to
                    10 accounts.
                  </p>
                </div>
                ...
                {accounts.map((acc) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <button
                        onClick={() =>
                          handleConnectionToggle(acc.id, acc.connected)
                        }
            ...
            {userPlan !== "agency" && (
              <div className="absolute inset-0 z-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8 rounded-2xl">
                ...
                <p className="text-slate-600 dark:text-slate-400 max-w-md mb-6">
                  Collaborate with your team, assign roles, and manage approval
                  workflows with the Agency plan.
                </p>
                <button
                      ...
                      <tr key={member.id} className="group">
                        ...
                        <td className="py-4">
                          <select className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-xs rounded-lg px-2 py-1 font-medium outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            <option selected={member.role === "editor"}>
                              Editor
                            </option>
              ...
              <div className="space-y-6">
                <div className="flex items-start justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
                      Receive a weekly summary of your performance and upcoming
                      posts.
                    </p>
                  </div>
                  <button
                ...
                <div className="flex items-start justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
                      Alert me when someone mentions my brand or comments on a
                      post.
                    </p>
                  </div>
                  <button
          ...
          <div className="space-y-6 animate-in fade-in duration-300 relative">
            {userPlan !== "agency" && (
              <div className="absolute inset-0 z-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8 rounded-2xl">
                ...
                <p className="text-slate-600 dark:text-slate-400 max-w-md mb-6">
                  Upgrade to the Agency plan to remove SocialFlow branding and
          ...
          <div className="space-y-6 animate-in fade-in duration-300 relative">
            {userPlan !== "agency" && (
              <div className="absolute inset-0 z-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8 rounded-2xl">
                ...
                <p className="text-slate-600 dark:text-slate-400 max-w-md mb-6">
                  Access our REST API and Webhooks to build custom integrations
                  and workflows with the Agency plan.
                </p>
                <button
                  onClick={onOpenUpgrade}
                  className="px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/30"
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <nav className="space-y-1">
            {[
              ...
              const isLocked =
                ((item.id === "branding" || item.id === "developer") &&
                  userPlan !== "agency") ||
